...
class AcceptRequestScreen extends StatelessWidget {
  ...
  final String acceptRequestEndpoint;

  AcceptRequestScreen({required this.requestId})
      : acceptRequestEndpoint = '$url/owner/requests/accept/$requestId';

  Future<void> acceptRequest() async {
    try {
      final response = await http.post(Uri.parse(acceptRequestEndpoint),
